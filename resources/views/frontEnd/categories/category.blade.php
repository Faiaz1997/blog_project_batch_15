                ...
                <div class="col-md-9" data-aos="fade-up">
                    ...
                    @foreach($categoryWiseBlogs as $categoryWiseBlogs)
                        <div class="d-md-flex post-entry-2 half">
                            <a href="{{route('blog.detail',['slug'=>$categoryWiseBlogs->slug])}}" class="me-4 thumbnail">
                                <img src="{{asset($categoryWiseBlogs->image)}}" alt=""
                                     class="img-fluid">
                            </a>
                            <div>
                                <div class="post-meta"><span class="date">{{$categoryWiseBlogs->category_name}}</span>
                                    <span
                                        class="mx-1">&bullet;</span> <span>{{date(" M jS 'y ",strtotime($categoryWiseBlogs->date))}}</span></div>
                                <h3><a href="{{route('blog.detail',['slug'=>$categoryWiseBlogs->slug])}}">{{$categoryWiseBlogs->title}}</a></h3>
                                <p>{{substr($categoryWiseBlogs->description,0,250)}}</p>
                                <div class="d-flex align-items-center author">
                                    {{--                                    <div class="photo"><img src="{{asset('frontEndAsset')}}/assets/img/person-2.jpg"--}}
                                    {{--                                                            alt="" class="img-fluid"></div>--}}
                                    <div class="name">
                                        <h3 class="m-0 p-0">{{$categoryWiseBlogs->author_name}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
